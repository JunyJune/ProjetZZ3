...
public class CSVtoNEO {
	...
	public Vector<String> getVector(){
		...
		public void execute (String filePath) throws Exception{
			   ...
			   convertCSVtoSQL(filePath, vect_table);					 
		}

		private static void convertCSVtoSQL(String filePath, Vector<CSVtoSQL> v_table) throws Exception{
			//récuperation du CSV
			CSVReader reader = new CSVReader(new FileReader(filePath));
		     try{
	    		...
	    		File neofile = new File("C:/Users/Aude/Desktop/ZZ3/ProjetZZ3/DataFiles/data.txt");
